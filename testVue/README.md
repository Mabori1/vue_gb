...
- [Интерьерное бюро \"Interno\". SPA приложение на Vue.js 3.](#интерьерное-бюро-interno-spa-приложение-на-vuejs-3)
  - [Иcпользуемые технологии](#иcпользуемые-технологии)
  - [Техническое задание](#техническое-задание)
  - [Реализованные задачи](#реализованные-задачи)
  - [Ссылка на макет проекта](#ссылка-на-макет-проекта)
  - [Ссылка на GitHub Pages](#ссылка-на-github-pages)
  - [Настройка проекта](#настройка-проекта) - [Компиляция и выполнение горячей перезагрузки для разработки](#компиляция-и-выполнение-горячей-перезагрузки-для-разработки) - [Компиляция и сжатие для продакшена](#компиляция-и-сжатие-для-продакшена) - [Настройка конфигурации](#настройка-конфигурации)
  <!--toc:end-->
...
Посмотреть [Сайт Interno](https://mabori1.github.io/test-vue/)
